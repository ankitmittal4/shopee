...
function OrderDetails() {
  ...
  return (
    ...
    //       Order Id:{orderInfo.orderId?.slice(0, 6)}
    //     </div>
    //   </div>
    ...
    //           <label
    //             htmlFor="firstName"
    //             className="block text-sm text-gray-600/80"
    //           >
    //             Customer Name
    //           </label>
    //           <input
    ...
    //             id="firstName"
    //             name="firstName"
    //             className="mt-1 block w-full border rounded-md px-2 py-2 text-gray-600 "
    //             disabled
    ...
    // </div>
    <>
      <div className="ml-72 p-4">Order0</div>
    </>
  );
}
