          ...
          <table className="min-w-full divide-y divide-gray-200 bg-neutral-200">
            <thead className="bg-[#5C5C5C]">
              <tr>
                ...
                <th className="px-0 py-3 text-left text-xs  text-white font-bold  tracking-wider">
                  Id
                </th>
                <th className="px-6 py-3 text-left text-xs  text-white font-bold  tracking-wider">
                  Name & Phone No
                ...
                <th className="px-4 py-3 text-left text-xs  text-white font-bold  tracking-wider">
                  Inventory
                </th>
                <th className="px-6 py-3 text-left text-xs  text-white font-bold  tracking-wider">
                  Status
