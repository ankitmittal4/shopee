...
//                 <spanc className="text-red-500 text-lg text-center">*</spanc>
//               </label> */}
//                 {/* <div className="mt-1 block w-full border rounded-md px-2 py-2 text-red-600 focus:outline-green-500 cursor-pointer"
...
//                 }}
//                 onBlur={handleBlur}
//                 className="mt-1 block w-full border rounded-md px-2 py-2 text-red-600 focus:outline-green-500 cursor-pointer"
//               />
//               {errors.shopImage && touched.shopImage && (
//                 <p className="text-red-500 text-sm">{errors.shopImage}</p>
//               )} */}
//                 <div
//                   className="mt-1 w-40 h-40 border rounded-md flex items-center justify-center cursor-pointer bg-gray-100 text-red-400 border-neutral-200  hover:border-green-500"
